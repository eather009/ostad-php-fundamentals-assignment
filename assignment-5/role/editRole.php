...
?>
<form action="editRole.php?name=<?php echo $_GET['name'] ?>" method="post">
    <input type="hidden" value="Edit" name="actionType">
    <label>
        <input type="text" name="rolename" placeholder="Role Name" value="<?php echo $_GET['name'] ?>" required>
    </label>
    <button type="submit">Edit</button>
    <a href="/role.php">Return</a>
</form>
